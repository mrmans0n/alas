...
- Refuse scheduled worktree cleanup when initialized submodule history is not remote-reachable, finalize reports promptly after schedule cancellation, and retain worktrees when report finalization fails (#1465).
