...
struct GGInboxModelsTests {
    ...
    @Test func bucketMetadataPriorityOrderAndAccessors() throws {
        ...
        #expect(GGInboxBucket.refreshFailed.themeToken == "del")
        #expect(GGInboxBucket.readyToLand.themeToken == "add")
        #expect(GGInboxBucket.changesRequested.themeToken == "del")
        #expect(GGInboxBucket.blockedOnCi.themeToken == "caution")
        #expect(GGInboxBucket.awaitingReview.themeToken == "accent")
        #expect(GGInboxBucket.behindBase.themeToken == "warn")
        #expect(GGInboxBucket.draft.themeToken == "fg-muted")
        let snapshot = try GGInboxSnapshot.decode(fromJSON: Data(Self.fullSample.utf8))
