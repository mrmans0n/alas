...
enum Paths {
    ...
    static var globalTabsFile: URL { appSupportRoot.appendingPathComponent("global-tabs.json") }
...
extension Paths {
    ...
    static var missionsDB: URL {
        appSupportRoot.appendingPathComponent("missions.sqlite")
    }
}
